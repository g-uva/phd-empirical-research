...
def main():
    ...
    config = read_from_json(config_path, cat="op_mat_mul_pmc")
    ...
    for model, m_config in m_configs.items():
        ...
        for op_name in op_names:
            ...
            if cnt_m == 0:
                ax.text(mean_pmc, mean_time, op_label, fontsize=6, color="grey")
        scatter = ax.scatter(
    ...
    ax.set_xlabel("Memory access (Read and write) (MB)", fontsize=8)
